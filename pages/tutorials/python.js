    ...
    <div>
      ...
      <div className="min-h-screen flex flex-col">
        <div className="flex-1 flex flex-row overflow-y-hidden mt-16">
          ...
          <nav className="max-h-screen order-first w-[19%] bg-white border overflow-y-auto px-3 py-1 ">
            <aside class="">
              <nav class="space-y-8 text-sm">
                <div class="space-y-2">
                  <h2 class="text-sm font-bold tracking-wider text-purple-700">
                    Python Tutorial
                  </h2>
          ...
          <aside className="w-[19%] bg-white border overflow-y-auto">
            Right Sidebar
          </aside>
        </div>
      </div>
